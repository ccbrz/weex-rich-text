...
public class InsertTableDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TextInputEditText columnCountEditText = (TextInputEditText) view.findViewById(R.id.column_count);
        final TextInputEditText rowCountEditText = (TextInputEditText) view.findViewById(R.id.row_count);
