package com.eros.framework.extend.comoponents.eewebview.view;

/**
 * Created by limingyi on 2020/8/8.
 *
 * @description:
 */
...
import com.eros.framework.extend.comoponents.eewebview.WebCallBean;
import com.eros.framework.extend.comoponents.eewebview.webviewBridge.InjectedChromeClient;
...
//        WebCallBean.addClassData("navigationBar", WebNavigationBarModule.class);
    ...
    private void initSetting() {
        ...
        //设置UA
        this.userAgent = webSettings.getUserAgentString() + ";android_kuaifan_eeui/";
        setUserAgent("");
    }
