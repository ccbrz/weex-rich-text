...
public class InsertLinkDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TextInputEditText textToDisplayEditText = (TextInputEditText) view.findViewById(R.id.text_to_display);
        final TextInputEditText linkToEditText = (TextInputEditText) view.findViewById(R.id.link_to);

        AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity(),R.style.Theme_AppCompat_Light_Dialog_Alert);
