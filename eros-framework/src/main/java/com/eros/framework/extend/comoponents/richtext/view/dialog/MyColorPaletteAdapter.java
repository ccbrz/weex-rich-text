...
public class MyColorPaletteAdapter extends BaseAdapter {
    ...
    private final class ViewHolder {
        ...
        void setup(int position) {
            ...
            if (alpha != 255) {
                if (alpha <= MyColorPickerDialog.ALPHA_THRESHOLD) {
