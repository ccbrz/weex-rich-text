package com.eros.framework.extend.comoponents.eewebview;
...
import com.eros.framework.extend.comoponents.eewebview.view.ExtendWebView;
import com.eros.framework.extend.comoponents.eewebview.webviewBridge.eeuiJson;
import com.eros.framework.extend.comoponents.eewebview.webviewBridge.eeuiParse;
 ...
 */
public class EEWebView extends WXVContainer<ViewGroup> {
    ...
    public EEWebView(WXSDKInstance instance, WXDomObject node, WXVContainer parent) {
...
//        }
    ...
    private void initPagerView() {
        v_webview = (ExtendWebView) mView.findViewById(R.id.v_webview);
        //
